...
class VWAPDMISSafe_V3(IStrategy):
    """
    ...
    def custom_stoploss(
        ...
        **kwargs,
        ...
        """
        # Find candle at entry to ensure static risk
        dataframe, _ = self.dp.get_analyzed_dataframe(pair, self.timeframe)
        entry_date = trade.open_date_utc
        # Efficiently find the row (this works for both localized and naive timestamps if consistent)
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        # Find candle at entry to ensure static risk target
        entry_date = trade.open_date_utc
        entry_candle = dataframe.loc[dataframe["date"] == entry_date]
