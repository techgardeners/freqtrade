...
class VWAPDMISSafe_V3Short(IStrategy):
    """
    VWAP + DMI Trend Strategy (Short-Only Version)
    Author: Antigravity
    Version: 1.2.0

    SHORT-ONLY variant based on analysis showing:
    - Long trades: -2.78% profit
    - Short trades: +95.00% profit
    - Win Rate: 88.2%

    Based on Rolling VWAP and DMI/ADX to identify clean downtrends on 1H timeframe.
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # LONG Conditions - DISABLED
        # Analysis showed Longs losing (-2.78%) while Shorts profitable (+95%)
